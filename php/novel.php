...
<div class="card-deck">
	<div class="card" style="width: 18rem;">
		<img src="n1.jpeg" class="card-img-top img1" alt="...">
		<div class="card-body">
			<h5 class="card-title">Rs 200</h5>
			<p class="card-text">Wings Of Fire.   An autobiography Of Dr. APJ Abdul Kalam.</p>
			<a href="n1.php" class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal">Buy Now</a>
  		</div>
	</div>
	<div class="card" style="width: 18rem;">
		<img src="n2.jpeg" class="card-img-top img1" alt="...">
		<div class="card-body">
			<h5 class="card-title">Rs 300</h5>
			<p class="card-text">Jane Austen (Novel)</p>
			<a href="n2.php" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal1">Buy Now</a>
  		</div>
	</div>
	<div class="card" style="width: 18rem;">
		<img src="n3.jpeg" class="card-img-top img1" alt="...">
		<div class="card-body">
			<h5 class="card-title">Rs 350</h5>
			<p class="card-text">The Lord of the Rings</p>
			<a href="n3.php" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal2">Buy Now</a>
  		</div>
	</div>
	<div class="card" style="width: 18rem;">
    		<img src="fiction2.jpg" class="card-img-top img1" alt="...">
    		<div class="card-body">
      			<h5 class="card-title">Rs 100</h5>
      			<p class="card-text">We Must Be BRAVE(NOVEL)</p>
      			<a href="fiction2.php" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal3">Buy Now</a>
    		</div>
  	</div>
</div>
<br>
