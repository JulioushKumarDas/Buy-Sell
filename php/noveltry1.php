...
<html lang="en">
  <head>
	...
	.carousel-item
		...
		.img1{height:250px;}
		.try1{background-color:rgba(0,0,0,1);}
    </style>
  </head>
  <body>
   <!-- A grey horizontal navbar that becomes vertical on small screens -->
	...
	$q="select titlename,description,category,image1,image2,price from selltable where category='novel'";
	$result=$con->query($q);
	...
	{
		echo ("<h1><center>Oops! Not a Single Item In This List for now..</h1></center>");
	}
?>
<!--</div>-->
</br>
