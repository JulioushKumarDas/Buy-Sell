...
<html lang="en">
  ...
  <body>
   <!-- A grey horizontal navbar that becomes vertical on small screens -->
	...
	<div class="new1">
                <h1>Variety Of books</h1>
        </div></br></br>
	<!--<div class="card-deck">-->
	<?php
	$con=mysqli_connect('localhost','root',);
	mysqli_select_db($con,'userregistration');
	$q="select titlename,description,category,image1,price,image2 from selltable where category='other'";
	$result=$con->query($q);
	...
	{
		echo ("<center><h1>Oops! Not a single Item in this category for now..</h1></center>");
	}
?>
<!--</div>-->
</br>
